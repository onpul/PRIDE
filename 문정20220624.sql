...
CREATE SEQUENCE SEQ_DEL_RIDING
NOCACHE;

DELETE
FROM DELETED_RIDING
WHERE DEL_RIDING_ID = 10;

INSERT INTO DELETED_RIDING
VALUES(SEQ_DEL_RIDING.NEXTVAL, 61, SYSDATE);
...
FROM PARTICIPATED_MEMBER P, RIDING R
WHERE P.USER_ID= 9
  AND P.RIDING_ID=R.RIDING_ID
...
LEFT JOIN DELETED_RIDING D
ON P.RIDING_ID = D.RIDING_ID
WHERE D.RIDING_ID IS NULL 
AND USER_ID = 9;
