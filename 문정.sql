...
VALUES(SEQ_RIDING.NEXTVAL, '2'
    ...
    ,'5678','5678','한강','한강gs앞'
    ,'1010','1010','풍성빌딩','풍성빌딩4층',NULL,NULL);

COMMIT;

SELECT *
FROM RIDING
WHERE RIDING_ID IS NOT NULL
ORDER BY START_DATE;
...
SELECT RIDING_ID, LEADER_ID, STEP_ID, SPEED_ID, MOOD_P_ID, DINING_P_ID
     , EAT_P_ID, AGE_P_ID, SEX_P_ID, E_GRADE_ID, RIDING_NAME, START_DATE
     , END_DATE, CREATED_DATE, MAXIMUM, MEET_LATI, MEET_LONGI, MEET_ADDRESS
     , MEET_DETAIL, START_LATI, START_LONGI, START_ADDRESS, START_DETAIL
     , END_LATI, END_LONGI, END_ADDRESS, DETAIL_ADDRESS, CONFIRM_DATE, COMMENTS
FROM RIDING;
...
SELECT R.RIDING_ID, R.LEADER_ID, R.STEP_ID, R.SPEED_ID, R.MOOD_P_ID, R.DINING_P_ID
     ...
     , R.END_LATI, R.END_LONGI, R.END_ADDRESS, R.START_DETAIL, R.CONFIRM_DATE, R.COMMENTS
...
SELECT S.SP_CONTENT
FROM RIDING R JOIN SEX_PREFERENCE S ON R.SEX_P_ID = S.SEX_P_ID 
WHERE RIDING_ID = 6;
COMMIT;
...
INSERT INTO NOTICE
VALUES(SEQ_NOTICE.NEXTVAL, 105, 1, SYSDATE, NULL);
INSERT INTO NOTICE
VALUES(SEQ_NOTICE.NEXTVAL, 105, 2, SYSDATE, NULL);
...
VALUES(SEQ_WITHDRAW.NEXTVAL, 113, SYSDATE);
...
SELECT *
FROM PROFILE
where email = 'penalty@test.com'
ORDER BY TO_NUMBER(USER_ID);

UPDATE PROFILE
SET EMAIL = 'penalty@test.com', PASSWORD = '12341234'
WHERE USER_ID = 2;
